...
export const DEFAULT_SETTINGS: editingToolbarSettings = {
    ...
    "menuCommands": [
      {
        "id": "editing-toolbar-math:editor-undo",
        "name": "Undo Edit",
        "icon": "undo-glyph"
      },
      {
        "id": "editing-toolbar-math:editor-redo",
        "name": "Redo Edit",
        "icon": "redo-glyph"
      },
      {
      ...
      {
        "id": "editing-toolbar-math:format-eraser",
        "name": "Clear Text Formatting",
        "icon": "eraser"
      },
      {
        "id": "editing-toolbar-math:header2-text",
        "name": "Header 2",
        "icon": "header-2"
      },
      {
        "id": "editing-toolbar-math:header3-text",
        "name": "Header 3",
        "icon": "header-3"
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:header1-text",
            "name": "Header 1",
            "icon": "header-1"
          },
          {
            "id": "editing-toolbar-math:header4-text",
            "name": "Header 4",
            "icon": "header-4"
          },
          {
            "id": "editing-toolbar-math:header5-text",
            "name": "Header 5",
            "icon": "header-5"
          },
          {
            "id": "editing-toolbar-math:header6-text",
            "name": "Header 6",
            "icon": "header-6"
          }
        ]
      ...
      {
        "id": "editing-toolbar-math:toggle-bold",
        "name": "Bold",
        "icon": "bold-glyph"
      },
      {
        "id": "editing-toolbar-math:toggle-italics",
        "name": "Italic",
        "icon": "italic-glyph"
      },
      {
        "id": "editing-toolbar-math:toggle-strikethrough",
        "name": "Strikethrough",
        "icon": "strikethrough-glyph"
      },
      {
        "id": "editing-toolbar-math:underline",
        "name": "Underline",
        "icon": "underline-glyph"
      },
      {
        "id": "editing-toolbar-math:toggle-highlight",
        "name": "Highlight",
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:get-plain-text",
            "name": "Get Plain Text",
            "icon": "lucide-file-text"
          },

          {
            "id": "editing-toolbar-math:smart-symbols",
          ...
          {
            "id": "editing-toolbar-math:insert-blank-lines",
            "name": "Insert Blank Lines",
            "icon": "lucide-space"
          },
          {
            "id": "editing-toolbar-math:remove-blank-lines",
            "name": "Remove Blank Lines",
            "icon": "lucide-minimize-2"
          },
          {
            "id": "editing-toolbar-math:split-lines",
            "name": "Split Lines",
            "icon": "lucide-split"
          },
          {
            "id": "editing-toolbar-math:merge-lines",
            "name": "Merge Lines",
            "icon": "lucide-merge"
          },
          {
            "id": "editing-toolbar-math:dedupe-lines",
            "name": "Dedupe Lines",
            "icon": "lucide-filter"
          },
          {
          ...
          {
            "id": "editing-toolbar-math:add-wrap",
            "name": "Add Prefix/Suffix",
            "icon": "lucide-wrap-text"
          },
          {
            "id": "editing-toolbar-math:number-lines",
            "name": "Number Lines (Custom)",
            "icon": "lucide-list-ordered"
          },
          {
            "id": "editing-toolbar-math:remove-whitespace-trim",
            "name": "Trim Line Ends",
            "icon": "lucide-scissors"
          },
          {
            "id": "editing-toolbar-math:remove-whitespace-compress",
            "name": "Shrink Extra Spaces",
            "icon": "lucide-minimize"
          },
          {
            "id": "editing-toolbar-math:remove-whitespace-all",
          ...
          {
            "id": "editing-toolbar-math:list-to-table",
            "name": "List to Table",
            "icon": "lucide-table"
          },
          {
            "id": "editing-toolbar-math:table-to-list",
            "name": "Table to List",
            "icon": "lucide-list"
          },
          {
            "id": "editing-toolbar-math:extract-between",
      ...
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:editor-cut",
            "name": "Cut",
            "icon": "lucide-scissors"
          },
          {
            "id": "editing-toolbar-math:editor-copy",
            "name": "Copy",
            "icon": "lucide-copy"
          },
          {
            "id": "editing-toolbar-math:editor-paste",
            "name": "Paste",
            "icon": "lucide-clipboard-type"
          },
          {
            "id": "editing-toolbar-math:editor:swap-line-down",
            "name": "Swap Line Down",
            "icon": "lucide-corner-right-down"
          },
          {
            "id": "editing-toolbar-math:editor:swap-line-up",
            "name": "Swap Line Up",
      ...
      {
        "id": "editing-toolbar-math:editor:attach-file",
        "name": "Attach File",
        "icon": "lucide-paperclip"
      },
      {
        "id": "editing-toolbar-math:editor:insert-table",
        "name": "Insert Table",
        "icon": "lucide-table"
      },
      {
        "id": "editing-toolbar-math:editor:cycle-list-checklist",
      ...
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:editor:toggle-blockquote",
            "name": "Blockquote",
            "icon": "lucide-text-quote"
          },
          {
            "id": "editing-toolbar-math:insert-callout",
            "name": "Callout",
            "icon": "lucide-quote"
          }
        ]
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:superscript",
            "name": "Superscript",
            "icon": "superscript-glyph"
          },
          {
            "id": "editing-toolbar-math:subscript",
            "name": "Subscript",
            "icon": "subscript-glyph"
          },
          {
            "id": "editing-toolbar-math:editor:toggle-code",
            "name": "Inline Code",
            "icon": "code-glyph"
          },
          {
            "id": "editing-toolbar-math:codeblock",
            "name": "Code Block",
            "icon": "codeblock-glyph"
          },
          {
            "id": "editing-toolbar-math:editor:insert-wikilink",
            "name": "Wikilink",
          ...
          {
            "id": "editing-toolbar-math:editor:insert-embed",
            "name": "Embed",
            "icon": "note-glyph"
          },
          {
            "id": "editing-toolbar-math:insert-link",
            "name": "Link",
            "icon": "link-glyph"
          },
          {
            "id": "editing-toolbar-math:hrline",
          ...
          {
            "id": "editing-toolbar-math:toggle-inline-math",
            "name": "Inline Math",
            "icon": "lucide-sigma"
          },
          {
            "id": "editing-toolbar-math:editor:insert-mathblock",
            "name": "MathBlock",
      ...
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:editor:toggle-checklist-status",
            "name": "Checklist",
            "icon": "checkbox-glyph"
          },
          {
            "id": "editing-toolbar-math:renumber-ordered-list",
            "name": "Renumber Ordered List",
            "icon": "list-restart"
          },
          {
            "id": "editing-toolbar-math:toggle-numbered-list",
            "name": "Ordered List",
          ...
          {
            "id": "editing-toolbar-math:toggle-bullet-list",
            "name": "Unordered List",
          ...
          {
            "id": "editing-toolbar-math:undent-list",
            "name": "Unindent List",
          ...
          {
            "id": "editing-toolbar-math:indent-list",
            "name": "Indent list",
      ...
      },
      {
        ...
        "SubmenuCommands": [
          {
            "id": "editing-toolbar-math:justify",
            "name": "Justify Text",
          ...
          {
            "id": "editing-toolbar-math:center",
            "name": "Center Text",
            "icon": "<svg width=\"18\" height=\"18\" focusable=\"false\" fill=\"currentColor\"  viewBox=\"0 0 1024 1024\"><g transform=\"scale(1, -1) translate(0, -896) scale(0.9, 0.9) \"><path class=\"path\" d=\"M724 304 q17 0 28.5 -11.5 q11.5 -11.5 11.5 -28 q0 -16.5 -11.5 -28.5 q-11.5 -12 -27.5 -12 l-421 0 q-17 0 -28.5 11.5 q-11.5 11.5 -11.5 28 q0 16.5 11.5 28.5 q11.5 12 27.5 12 l421 0 ZM872 540 q17 0 28.5 -11.5 q11.5 -11.5 11.5 -28 q0 -16.5 -11.5 -28.5 q-11.5 -12 -27.5 -12 l-721 0 q-17 0 -28.5 11.5 q-11.5 11.5 -11.5 28 q0 16.5 11.5 28.5 q11.5 12 27.5 12 l721 0 ZM724 776 q17 0 28.5 -11.5 q11.5 -11.5 11.5 -28 q0 -16.5 -11.5 -28.5 q-11.5 -12 -27.5 -12 l-421 0 q-17 0 -28.5 11.5 q-11.5 11.5 -11.5 28 q0 16.5 11.5 28.5 q11.5 12 27.5 12 l421 0 ZM872 68 q17 0 28.5 -11.5 q11.5 -11.5 11.5 -28 q0 -16.5 -11.5 -28.5 q-11.5 -12 -27.5 -12 l-721 0 q-17 0 -28.5 11.5 q-11.5 11.5 -11.5 28 q0 16.5 11.5 28.5 q11.5 12 27.5 12 l721 0 Z\"></path></g></svg>"
          },
          {
            "id": "editing-toolbar-math:right",
      ...
      {
        "id": "editing-toolbar-math:change-font-color",
      ...
      {
        "id": "editing-toolbar-math:change-background-color",
      ...
      {
        "id": "editing-toolbar-math:fullscreen-focus",
        "name": "Fullscreen Focus Mode",
        "icon": "fullscreen"
      },
      {
        "id": "editing-toolbar-math:workplace-fullscreen-focus",
